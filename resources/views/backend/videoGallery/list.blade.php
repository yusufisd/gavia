                    ...
                    <div class="card card-flush h-xl-100 mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <!--begin::Add user-->
                                    <a type="button" class="btn btn-outline btn-outline-success" href="{{route('admin.videoGallery.add')}}">
                                        <i class="fa-solid fa-plus"></i>Yeni Ekle</a>
                                    <!--end::Add user-->

                                    <a type="button" class="btn btn-outline btn-outline-success ms-5"
                                        href="{{route('admin.videoGalleryCategory.list')}}">
                                        <i class="fa fa-address-card" aria-hidden="true"></i>Video Galeri Kategorileri</a>
                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            <div class="table-responsive with_search_table">
                                <table id="video_table" class="table gy-7 gx-7">
                                    <thead>
                                            ...
                                            <th class="w-10px">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                        data-kt-check-target="#video_table .my-input " value="1" />
                                                </div>
                                            </th>
                                            <th>Resim<i class="fa fa-sort ms-3"></i></th>
                                            <th>Galeri Adı<i class="fa fa-sort ms-3"></i></th>
                                            ...
                                            <td class="text-center">
                                                <div
                                                    ...
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="video_status_1" checked="checked">
                                                    <label class="form-check-label" for="video_status_1"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href=""
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div
                                                    class="form-check form-check-solid form-switch form-check-custom fv-row justify-content-center">
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="video_status_2" checked="">
                                                    <label class="form-check-label" for="video_status_2"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href=""
