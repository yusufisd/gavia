                    ...
                    <div class="card card-flush h-xl-100 mb-5 mb-xl-8">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <a type="button" class="btn btn-outline btn-outline-success"
                                        href="{{route('admin.galleryCategory.add')}}">
                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            <div class="table-responsive with_search_table">
                                <table id="photo_gallery_category_table" class="table gy-7 gx-7">
                                    <thead>
                                            ...
                                            <th class="w-10px">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                        data-kt-check-target="#photo_gallery_category_table .my-input "
                                                        value="1" />
                                                </div>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="photo_gallery_category_status_1" checked="checked">
                                                    <label class="form-check-label"
                                                        for="photo_gallery_category_status_1"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="edit_photo_category.html"
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div
                                                    class="form-check form-check-solid form-switch form-check-custom fv-row justify-content-center">
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="photo_gallery_category_status_2" checked="">
                                                    <label class="form-check-label"
                                                        for="photo_gallery_category_status_2"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href=""
...
@section('script')
    ...
    <script>
        ...
        $("#photo_gallery_category_table").DataTable({
            "ordering": true,
            "order": [
                [0, "asc"]
            ],
