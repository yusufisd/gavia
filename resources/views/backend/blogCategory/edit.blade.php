    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row g-5 g-xl-8">
                ...
                <form action="{{ route('admin.blogCategory.update',$data_tr->id) }}" method="POST">
                    @csrf
                    <!--begin::Col-->
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 fv-row">
                                                            <input type="number" name="blog_category_detail_no"
                                                ...
                                                <div class="tab-content" id="TabContent_2">
                                                        <div class="tab-pane fade show active"
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-12 fv-row">
                                                                                <input type="text"
                                                                                    value="{{ $data_tr->title }}"
                                                                                    name="blog_category_name_tr"
                                                                                    id="blog_category_name_tr"
                                                                            ...
                                                                            <div class="col-lg-12 fv-row">
                                                                                <div class="row">
                                                                                    <div class="col-lg-10">
                                                                                        <input type="text"
                                                                                            value="{{ $data_tr->link }}"
                                                                                            id="blog_category_url_tr"
                                                                                            name="blog_category_url_tr"
                                                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                                                                                    </div>
                                                                                    <div class="col-lg-2">
                                                                                        <button type="submit"
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    id="btn_submit_blog_category_detail_tr"><i
                                                                        class="fa-solid fa-check ps-1"></i>
                                                                    KAYDET</button>
                                                            </div>
                                                            <!--end::Actions-->
                                                            <!--end::Form-->
                                                    ...
                                                    <div class="tab-pane fade" id="tab_blog_category_detail_en"
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 fv-row">
                                                                            <div class="row">
                                                                                <div class="col-lg-10">
                                                                                    <input type="text" value="{{$data_en->link}}"
                                                                                        name="blog_category_url_en"
                                                                                        id="blog_category_url_en"
                                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                                        value="" />
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                        ...
                                                        <div class="card-footer d-flex justify-content-between py-6 px-0">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-outline btn-outline-success"
                                                                id="btn_submit_blog_category_detail_en"><i
                                                                    class="fa-solid fa-check ps-1"></i>
                                                                KAYDET</button>
                                                        </div>
                                                        <!--end::Actions-->
                                            ...
                                            <div class="tab-pane fade show active" id="tab_blog_category_seo_tr"
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        name="blog_category_seo_title_tr"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea name="blog_category_seo_description_tr" class="form-control form-control-lg form-control-solid"
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        id="blog_category_seo_keywords_tr"
                                                                        name="blog_category_seo_keywords_tr[]"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                        value="" />
                                                                </div>
                                                                <!--end::Col-->
                                                ...
                                                <div class="card-footer d-flex justify-content-between py-6 px-0">
                                                    ...
                                                    <button type="submit" class="btn btn-outline btn-outline-success"
                                                        id="btn_submit_blog_category_seo_tr"><i
                                            ...
                                            <div class="tab-pane fade" id="tab_blog_category_seo_en" role="tabpanel">
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        name="blog_category_seo_title_en" value="{{$data_en->seo_title}}"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                         />
                                                                </div>
                                                                <!--end::Col-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea name="blog_category_seo_description_en" class="form-control form-control-lg form-control-solid"
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        id="blog_category_seo_keywords_en"
                                                                        name="blog_category_seo_keywords_en[]"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                         />
                                                                </div>
                                                                <!--end::Col-->
                                                ...
                                                <div class="card-footer d-flex justify-content-between py-6 px-0">
                                                    ...
                                                    <div class="row mb-0">
                                                        ...
                                                        <div class="col-lg-4 d-flex align-items-center">
                                                            <div
                                                                class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                                <input class="form-check-input w-50px h-25px"
                                                                    type="checkbox" id="allowblog_category_seo_en"
                                                                    checked="checked" />
                                                                <label class="form-check-label"
                                                    ...
                                                    <button type="submit" class="btn btn-outline btn-outline-success"
                                                        id="btn_submit_blog_category_seo_en"><i
                                                            class="fa-solid fa-check ps-1"></i> KAYDET</button>
                                                </div>
                                                <!--end::Actions-->
                                                <!--end::Form-->
...
@section('script')
    ...
    <script>
        function create_slug_tr() {
            var Text = $("#blog_category_name_tr").val();
            Text = (slug(Text));
            $("#blog_category_url_tr").val(Text);
        }

        function create_slug_en() {
            var Text = $("#blog_category_name_en").val();
            Text = (slug(Text));
            $("#blog_category_url_en").val(Text);
        }
