                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        name="blog_category_seo_title_tr" id="blog_category_seo_title_tr"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                         />
                                                                </div>
                                                                <!--end::Col-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text"
                                                                        name="blog_category_seo_title_en" id="blog_category_seo_title_en"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                         />
                                                                </div>
                                                                <!--end::Col-->
...
@section('script')
    ...
    <script>
        function create_slug_tr() {
            ...
            Text2 = (slug(Text));
            $("#blog_category_url_tr").val(Text2);
            $("#blog_category_seo_title_tr").val(Text);
        ...
        function create_slug_en() {
            ...
            Text2 = (slug(Text));
            $("#blog_category_url_en").val(Text2);
            $("#blog_category_seo_title_en").val(Text);
        }
