                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 fv-row">
                                                                            <input type="text" name="activity_name_tr" id="activity_name_tr" onchange="create_slug_tr()"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 fv-row">
                                                                            <div class="row">
                                                                                <div class="col-lg-10">
                                                                                    <input type="text"
                                                                                        name="activity_url_tr" id="activity_url_tr"
                                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                                        value="" />
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                                ...
                                                                <div class="col-lg-4 d-flex align-items-center">
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input w-50px h-25px"
                                                                            ...
                                                                            checked="checked" name="allowactivity_detail_tr" />
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-12 fv-row">
                                                                            <input type="text" name="activity_name_en" id="activity_name_en" onchange="create_slug_en()"
                                                                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                                value="" />
                                                                        </div>
                                                                        <!--end::Col-->
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 fv-row">
                                                                            <div class="row">
                                                                                <div class="col-lg-10">
                                                                                    <input type="text"
                                                                                        name="activity_url_en" id="activity_url_en"
                                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                                        value="" />
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                                ...
                                                                <div class="col-lg-4 d-flex align-items-center">
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input w-50px h-25px"
                                                                            ...
                                                                            checked="checked" name="allowactivity_detail_en" />
                                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" name="activity_seo_title_tr" id="activity_seo_title_tr"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                        value="" />
                                                                </div>
                                                                <!--end::Col-->
                                                        ...
                                                        <div class="col-lg-4 d-flex align-items-center">
                                                            <div
                                                                ...
                                                                <input class="form-check-input w-50px h-25px"
                                                                    ...
                                                                    checked="checked" name="allowactivity_seo_tr" />
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" name="activity_seo_title_en" id="activity_seo_title_en"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                        value="" />
                                                                </div>
                                                                <!--end::Col-->
                                                        ...
                                                        <div class="col-lg-4 d-flex align-items-center">
                                                            <div
                                                                ...
                                                                <input class="form-check-input w-50px h-25px"
                                                                    ...
                                                                    checked="checked" name="allowactivity_seo_en" />
                                                                <label class="form-check-label"
