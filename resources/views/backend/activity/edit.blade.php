                                                ...
                                                <div class="col-lg-10 fv-row">
                                                    <select name="category" aria-label="Seçiniz" data-control="select2"
                                                        ...
                                                        @foreach ($categories as $item)
                                                            <option
                                                                {{ array_search($item->id, $data_tr->category_id) ? 'selected' : '' }}
                                                    ...
                                                    <div class="tab-pane fade show active" id="tab_activity_tr"
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 fv-row">
                                                                            <input type="text" name="activity_name_tr"
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10 fv-row">
                                                                    <textarea name="activity_summary_tr" class="form-control form-control-lg form-control-solid" value="">{{ $data_tr->short_description }}</textarea>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <label class="col-lg-4 col-form-label fw-bold fs-6"
                                                                            ...
                                                                            Başlangıç <br> Tarihi - Saati a</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-8">
                                                                            <!--begin::Row-->
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="add_activity_start_date_input_tr"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="add_activity_end_date_input_tr"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="add_activity_puslish_start_date_date_input_tr"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="activity_puslish_end_date_input_tr"
                                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-4 d-flex align-items-center">
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input w-50px h-25px"
                                                                            type="checkbox" id="allowactivity_detail_tr"
                                                                            {{$data_tr->statu == 1 ? 'checked' : ''}} />
                                                    ...
                                                    <div class="tab-pane fade" id="tab_activity_en" role="tabpanel">
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-12 fv-row">
                                                                            <input type="text" name="activity_name_en"
                                                                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                                value="{{$data_en->title}}" />
                                                                        </div>
                                                                        <!--end::Col-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10 fv-row">
                                                                    <textarea name="activity_summary_en" class="form-control form-control-lg form-control-solid" value=""> {{$data_en->short_description}} </textarea>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <label class="col-lg-4 col-form-label fw-bold fs-6"
                                                                            style="padding-top: 0px;">Etkinlik
                                                                            Başlangıç <br> Tarihi - Saatib</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-8">
                                                                            <!--begin::Row-->
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            id="add_activity_start_date_en"
                                                                                            type="text"
                                                                                            name="add_activity_start_date_en"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="add_activity_end_date_input_en"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="add_activity_puslish_start_date_date_input_en"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="col-lg-12 fv-row">
                                                                                    <div class="input-group"
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="activity_puslish_end_date_input_en"
                                                                                            class="form-control"
                                                            ...
                                                            <div class="row mb-0">
                                                                ...
                                                                <div class="col-lg-4 d-flex align-items-center">
                                                                    <div
                                                                        class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                                        <input class="form-check-input w-50px h-25px"
                                                                            type="checkbox" id="allowactivity_detail_en"
                                            ...
                                            <div class="tab-pane fade show active" id="tab_seo_tr" role="tabpanel">
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea name="activity_seo_description_tr" class="form-control form-control-lg form-control-solid" value=""> {{$data_tr->seo_description}} </textarea>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
                                            ...
                                            <div class="tab-pane fade" id="tab_seo_en" role="tabpanel">
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea name="activity_seo_description_en" class="form-control form-control-lg form-control-solid" value=""> {{$data_en->seo_description}} </textarea>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
