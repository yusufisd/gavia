                                                    ...
                                                    <div class="tab-pane fade show active" id="tab_blog_tr"
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10 fv-row">
                                                                    <textarea id="blog_summary_tr" onchange="create_ozet()" name="blog_summary_tr" class="form-control form-control-lg form-control-solid"></textarea>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        ...
                                                        <div class="card-footer d-flex justify-content-between py-6 px-0">
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                id="btn_submit_blog_detail_tr"><i
                                                    ...
                                                    <div class="tab-pane fade" id="tab_blog_en" role="tabpanel">
                                                        ...
                                                        <div class="card-body px-0 py-9">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10 fv-row">
                                                                    <textarea name="blog_summary_en" id="blog_summary_en" onchange="create_ozet_en()" class="form-control form-control-lg form-control-solid" value=""></textarea>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        ...
                                                        <div class="card-footer d-flex justify-content-between py-6 px-0">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-outline btn-outline-success"
                                                                id="btn_submit_blog_detail_en"><i
                                                                    class="fa-solid fa-check ps-1"></i> KAYDET</button>
                                                        </div>
                                                        <!--end::Actions-->
                                                        <!--end::Form-->
                                            ...
                                            <div class="tab-pane fade show active" id="tab_seo_tr" role="tabpanel">
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" name="blog_seo_title_tr" id="blog_seo_title_tr"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                       />
                                                                </div>
                                                                <!--end::Col-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea id="blog_seo_description_tr" name="blog_seo_description_tr" class="form-control form-control-lg form-control-solid" value=""></textarea>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
                                            ...
                                            <div class="tab-pane fade" id="tab_seo_en" role="tabpanel">
                                                ...
                                                <div class="card-body px-3 py-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10 fv-row">
                                                            <textarea name="blog_seo_description_en" id="blog_seo_description_en" class="form-control form-control-lg form-control-solid" value=""></textarea>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
