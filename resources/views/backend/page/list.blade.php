    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-10">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-primary fw-bold fs-3 flex-column justify-content-center my-0">Sayfalar
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                    ...
                    <div class="card card-flush h-xl-100 mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <!--begin::Add user-->
                                    <a type="button" class="btn btn-outline btn-outline-success" href="{{route('admin.page.add')}}">
                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            <div class="table-responsive with_search_table">
                                <table id="pages_table" class="table gy-7 gx-7">
                                    <thead>
                                            ...
                                            <th class="w-10px">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                        data-kt-check-target="#pages_table .my-input " value="1" />
                                                </div>
                                            </th>
                                            <th class="w-60">Sayfa Adı<i class="fa fa-sort ms-3"></i></th>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="page_status_1" checked="checked">
                                                    <label class="form-check-label" for="page_status_1"></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="w-60">Entertainment</td>
                                            <td>
                                                <div
                                                    class="form-check form-check-solid form-switch form-check-custom fv-row justify-content-center">
                                                    <input class="form-check-input w-50px h-25px" type="checkbox"
                                                        id="page_status_2" checked="">
                                                    <label class="form-check-label" for="page_status_2"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href=""
