                    ...
                    <div class="card card-flush h-xl-100 mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            <div class="table-responsive with_search_table">
                                <table id="activity_categories_table" class="table gy-7 gx-7">
                                    <thead>
                                            ...
                                            <th class="w-10px">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                        data-kt-check-target="#activity_categories_table .my-input "
                                                        value="1" />
                                                </div>
                                            </th>
                                            <th>Kategori Adı</th>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="edit_activity_category.html"
...
@section('script')
    <script>
        ...
        $("#activity_categories_table").DataTable({
            "ordering": true,
            "order": [
                [0, "asc"]
            ],
